...
class KeyboardTypePanel(StepConfigPanel):
    ...
    def init_ui(self):
        ...
        file_label.setStyleSheet(Styles.LABEL_SECTION)
        file_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)
        file_layout.addWidget(file_label)
        self.file_path_edit = QLineEdit()
        self.file_path_edit.setStyleSheet(Styles.small_line_edit())
        ...
        sheet_label.setStyleSheet(Styles.LABEL_SECTION)
        ...
        self.sheet_edit.setStyleSheet(Styles.small_line_edit())
        ...
        mode_label.setStyleSheet(Styles.LABEL_SECTION)
        ...
        self.read_mode_combo.setStyleSheet(Styles.small_combo_box())
        read_mode_view = QListView()
        read_mode_view.setStyleSheet(Styles.small_combo_view())
        ...
        self.cell_address_edit.setStyleSheet(Styles.small_line_edit())
        ...
        self.row_number_spin.setStyleSheet(Styles.small_spin_box())
        ...
        self.column_number_spin.setStyleSheet(Styles.small_spin_box())
        ...
        self.start_cell_edit.setStyleSheet(Styles.small_line_edit())
        self.end_cell_edit = QLineEdit()
        self.end_cell_edit.setPlaceholderText("结束: B5")
        self.end_cell_edit.setStyleSheet(Styles.small_line_edit())
        ...
        fmt_label.setStyleSheet(Styles.LABEL_SECTION)
        ...
        self.var_format_combo.setStyleSheet(Styles.small_combo_box())
        var_format_view = QListView()
        var_format_view.setStyleSheet(Styles.small_combo_view())
        ...
        self.variable_name_edit.setStyleSheet(Styles.small_line_edit())
        ...
        self.input_text_edit.setStyleSheet(Styles.small_text_edit())
        self.input_widget = QWidget()
        input_layout = QVBoxLayout(self.input_widget)
        input_layout.setContentsMargins(0, 0, 0, 0)
        input_layout.setSpacing(2)
        input_label = QLabel("输入内容:")
        input_label.setStyleSheet(Styles.LABEL_SECONDARY)
        ...
        self.interval_spin.setStyleSheet(Styles.small_double_spin_box())
        ...
        interval_label.setStyleSheet(Styles.LABEL_SECTION)
        ...
        self.random_min_spin.setStyleSheet(Styles.small_double_spin_box())
        ...
        self.random_max_spin.setStyleSheet(Styles.small_double_spin_box())
...
class KeyboardPressPanel(StepConfigPanel):
    ...
    def init_ui(self):
        ...
        self.key_combo.setStyleSheet(Styles.small_combo_box())
        key_view = QListView()
        key_view.setStyleSheet(Styles.small_combo_view())
...
class KeyboardHotkeyPanel(StepConfigPanel):
    ...
    def init_ui(self):
        ...
        self.main_key_combo.setStyleSheet(Styles.small_combo_box())
        main_key_view = QListView()
        main_key_view.setStyleSheet(Styles.small_combo_view())
        ...
        self.preview_text.setStyleSheet(Styles.preview_text())
