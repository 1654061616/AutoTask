...
| 任务 | 状态 | 说明 |
|------|------|------|
| 任务 1：创建 gui/styles/ 包 | ✅ 完成 | 4 个文件已创建 |
| 任务 2：创建 light.qss | ✅ 完成 | resources/themes/light.qss 已创建 |
| 任务 3：迁移 step_panels/__init__.py | ✅ 完成 | 所有内联样式已替换 |
| 任务 4：迁移 keyboard_panel.py | ✅ 完成 | 所有内联样式已替换 |
| 任务 5：迁移 mouse_panel.py | ⚠️ 部分 | 导入已添加，23 处内联样式待替换 |
| 任务 6：迁移 window_panel.py | ⚠️ 部分 | 导入已添加，部分替换，仍有内联样式 |
| 任务 7：迁移 image_panel.py | ⚠️ 部分 | 导入已添加，25 处内联样式待替换 |
| 任务 8：迁移 control_panel.py | ❌ 未开始 | 无导入 |
| 任务 9：迁移 excel_panel.py | ❌ 未开始 | 无导入 |
| 任务 10：迁移 node_editor_dialog.py | ❌ 未开始 | 无导入 |
| 任务 11：迁移 cron_generator.py | ❌ 未开始 | 无导入 |
| 任务 12：迁移 ui_builder.py | ❌ 未开始 | 无导入 |
| 任务 13：迁移 schedule_handler.py | ❌ 未开始 | 无导入 |
| 任务 14：迁移 schedule_panel.py | ❌ 未开始 | 无导入 |
| 任务 15：迁移 task_executor.py | ❌ 未开始 | 无导入 |
| 任务 16：迁移 task_manager.py | ❌ 未开始 | 无导入 |
| 任务 17：迁移 node_toolbar.py | ❌ 未开始 | 无导入 |
| 任务 18：删除 styles_bak.py | ✅ 完成 | 已删除 |
| 任务 19：验证 | ❌ 未开始 | - |
...
- [x] **步骤 2：替换 `StepConfigPanel.__init__` 中的面板背景**
...
- [x] **步骤 3：替换 `add_section_title` 方法**
